          ...
          body: Center(
            child: SizedBox(
              ...
              child: GridView.count(
                padding: EdgeInsets.symmetric(horizontal: (sqrt(MediaQuery
                    .of(context)
                    .size
                    .width) * sqrt(MediaQuery
                    .of(context)
                ...
                shrinkWrap: true,
                crossAxisCount: 2,
                crossAxisSpacing: (sqrt(MediaQuery
                    .of(context)
                    .size
                    .width) * sqrt(MediaQuery
                    .of(context)
                    .size
                    .height)) / 48,
                mainAxisSpacing: (sqrt(MediaQuery
                    .of(context)
                    .size
                    .width) * sqrt(MediaQuery
                    .of(context)
                      ...
                      onTap: () {
                        Navigator.of(context).push(MyRoute(
                            builder: (BuildContext context) =>
                                PictureMode(i, widget._displayAd))).then((
                            value) {
                          SharedPreferences.getInstance().then((
                              SharedPreferences _sp) {
                            for (int i = 0; i < 4; i++) {
                              if (_sp.getInt('_pic${(i + 1)}BestScore') !=
                                  null) {
                                _bestScores[i] =
                                _sp.getInt('_pic${(i + 1)}BestScore')!;
                              }
                            }
                            setState(() {});
                          });
                        ...
                        children: <Widget>[
                          Hero(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset(
                                'slide_assets/assets/assets/$i/original.jpg',
                              ),
                            ),
                          ),
                          Positioned.fill(
                            child: Center(
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Text>[
                                    Text(
                                      'Best score: ${(_bestScores[i - 1] == -1)
                                          ? ('-')
                                          : _bestScores[i - 1]}',
                                      style: TextStyle(
                                        fontSize: (sqrt(MediaQuery
                                            .of(context)
                                            .size
                                            .width) * sqrt(MediaQuery
                                            .of(context)
